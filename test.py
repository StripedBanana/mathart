...
# Créer la figure
plot = figure(width=1200, height=1200,title="Cercles dynamiques")
...
def update_circles(attr, old, new):
    ...
    for k in range(1, k_max+1):
        ...
        r.append(0.05 + 0.1*np.power(np.sin(52*np.pi*k/k_max), slider2.value))
...
slider2 = Slider(start=1, end=6, value=2, step=1, title="Puissance")
